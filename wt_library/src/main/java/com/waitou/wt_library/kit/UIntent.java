...
public class UIntent {
    ...
    public static Intent getInstallAppIntent(String filePath) {
        return getInstallAppIntent(UFile.getFileByPath(filePath));
    }
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            ...
            type = MimeTypeMap.getSingleton().getMimeTypeFromExtension(UFile.getFileExtension(file));
        }
    ...
    public static Intent getShareImageIntent(String content, String imagePath) {
        return getShareImageIntent(content, UFile.getFileByPath(imagePath));
    }
    ...
    public static Intent getShareImageIntent(String content, File image) {
        if (!UFile.isFileExists(image)) return null;
