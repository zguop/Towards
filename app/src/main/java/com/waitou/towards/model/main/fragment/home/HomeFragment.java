...
public class HomeFragment extends XFragment<HomePresenter, ViewDataBinding> implements SmartTabLayout.TabProvider {
...
//        initToolBar();
//        BasePagerFragmentAdapter adapter = new BasePagerFragmentAdapter(getChildFragmentManager(), getP().getHomeCommendFragment(), getP().getCargoFragment(), getP().getHomeAndroidFragment());
