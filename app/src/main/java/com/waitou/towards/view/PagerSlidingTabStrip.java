...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int selectTabTextColor = 0xFF666666;
    private int mCurSelectedIndex; //当前选中的index
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*--------------- 选中的字体及颜色 ---------------*/
        selectTabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextSize,
                selectTabTextSize);
        selectTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextColor, selectTabTextColor);
