...
public class ExBottomNavigationView extends BottomNavigationView implements SkinCompatSupportable {
    ...
    public ExBottomNavigationView(Context context) {
        super(context);
    }

    public ExBottomNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ExBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener getOnNavigationItemSelectedListener() {
        ...
        return getField(getClass().getSuperclass(), this, "mListener", OnNavigationItemSelectedListener.class);
    }
