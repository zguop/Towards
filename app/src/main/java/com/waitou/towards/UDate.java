...
//     * 返回指定日期的前一天
//     *
//     * @param sourceDate 日期字符串
//     * @param format     输入输出日期格式，如yyyy-MM-dd hh:mm:ss
//     * @return 返回日期字符串，形式和format一致
//     */
//    public static String getYesterday(String sourceDate, String format) {
//        return getFormatDateAdd(string2Date(sourceDate, format), -1, format);
//    }
//
//    /**
//     * 返回明天
//     *
//     * @param format 输出日期格式，如yyyy-MM-dd hh:mm:ss
//     * @return 返回日期字符串，形式和format一致。
//     */
//    public static String getFormatTomorrow(String format) {
//        return date2String(getDateAdd(getNowDate(), 1), format);
//    }
//
//    /**
//     * 返回昨天
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpan(String time0, String time1, @Unit int unit) {
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpan(String time0, String time1, @Unit int unit, String pattern) {
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpan(Date date0, Date date1, @Unit int unit) {
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpan(long millis0, long millis1, @Unit int unit) {
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpanByNow(String time, @Unit int unit) {
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpanByNow(String time, @Unit int unit, String pattern) {
...
//     * @return unit时间戳
//     */
//    public static long getTimeSpanByNow(Date date, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间戳
//     */
//    public static long getMillis(String time, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间戳
//     */
//    public static long getMillis(String time, String pattern, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间戳
//     */
//    public static long getMillis(Date date, long timeSpan, @Unit int unit) {
...
//     */
//    public static String getString(long millis, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间字符串
//     */
//    public static String getString(long millis, String pattern, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间字符串
//     */
//    public static String getString(String time, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间字符串
//     */
//    public static String getString(String time, String pattern, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间字符串
//     */
//    public static String getString(Date date, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的时间字符串
//     */
//    public static String getString(Date date, String pattern, long timeSpan, @Unit int unit) {
...
//     */
//    public static Date getDate(long millis, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的Date
//     */
//    public static Date getDate(String time, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的Date
//     */
//    public static Date getDate(String time, String pattern, long timeSpan, @Unit int unit) {
...
//     * @return 与给定时间等于时间差的Date
//     */
//    public static Date getDate(Date date, long timeSpan, @Unit int unit) {
...
//     */
//    public static String getStringByNow(long timeSpan, @Unit int unit) {
...
//     * @return 与当前时间等于时间差的时间字符串
//     */
//    public static String getStringByNow(long timeSpan, @Unit int unit, String pattern) {
...
//     */
//    public static Date getDateByNow(long timeSpan, @Unit int unit) {
