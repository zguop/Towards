...
import cn.droidlover.xdroid.theme.appres.AppCompatResources;
...
public class ThemeUtils {
     ...
     * @return Drawable
     */
    public static Drawable getDrawable(Context context, @AttrRes int color) {
        if (context == null) {
            return null;
        }
    ...
    public static int getAttr(Class draw, String attrName) {
        try {
            ...
            return com.waitou.lib_theme.R.attr.colorPrimary;
        }
    }
