...
public class XRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Cloneable {
    ...
    private static final int ITEM_TYPE_NORMAL = ITEM_TYPE_HEADER + 1000;        //normalItem
    ...
    private void putClass(Class clazz) {
        adapterClassMap.put(clazz, ITEM_TYPE_FOOTER + 100 * adapterClassMap.size());
    }

    private int getMapClassIntValue() {
        return adapterClassMap.get(baseAdapter.getClass());
    }
    ...
    public boolean addHeadView(int pos, View view) {
        ...
        notifyItemInserted(headerViewList.indexOf(pos));
        return true;
    }
